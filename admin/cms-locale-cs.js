/* Kompletní česká lokalizace Decap CMS + vlastní úpravy pro Psocházky */
    ...
    collection: {
      ...
      collectionTop: {
        ...
        searchResultsInCollection:
          'Výsledky vyhledávání pro "%{searchTerm}" v kolekci %{collection}',
    ...
    editor: {
      ...
      editor: {
        ...
        onUpdatingWithUnsavedChanges:
          "Máte neuložené změny. Před změnou stavu je prosím uložte.",
        onPublishingNotReady: 'Změňte stav na „Připraveno“ před publikováním.',
        onPublishingWithUnsavedChanges:
          "Máte neuložené změny, před publikováním je prosím uložte.",
        ...
        onDeleteUnpublishedChanges:
          "Všechny nepublikované změny v této položce budou vymazány. Chcete ji skutečně vymazat?",
        loadingEntry: "Načítání položky…",
        confirmLoadBackup:
          "Lokální kopie této položky byla nalezena, chcete ji použít?",
      },
      editorInterface: {
    ...
    ui: {
      ...
      errorBoundary: {
        ...
        recoveredEntry: {
          ...
          warning:
            "Prosím zkopírujte dokument do schránky před tím než odejdete z této stránky!",
      ...
      toast: {
        ...
        entryUpdated: "Stav položky byl změn",
        onDeleteUnpublishedChanges: "Nepublikované změny byly smazány",
        onFailToAuth: "%{details}",
        onLoggedOut:
          "Byli jste odhlášeni, prosím zálohujte všechna data a znova se přihlašte",
        onBackendDown:
